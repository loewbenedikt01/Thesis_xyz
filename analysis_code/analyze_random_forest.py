"""
analyze_random_forest.py — RandomForest Portfolio Analysis
=================================================
Imports all metric functions, crisis definitions, and plot generation
from metrics.py. This script retains RF-specific logic:
  ...
  - generate_rf_statistics_report() : time-series + summary table for DA, Spearman etc.
...
# ─────────────────────────────────────────────────────────────────────────────
# RF-SPECIFIC: STATISTICS REPORT
# ─────────────────────────────────────────────────────────────────────────────
def generate_rf_statistics_report(stats_df: pd.DataFrame, freq_name: str) -> str:
    """
    ...
    fig_ts.update_layout(
        title=dict(
            text=f"RandomForest Prediction Quality Over Time  ·  {freq_name}",
...
<head>
  <meta charset="utf-8">
  <title>RandomForest Portfolio — All Frequencies</title>
</head>
