...
for freq_name in FREQUENCIES:
    ...
    section_title = f'<h2 style="font-family:Inter,Arial,sans-serif;color:#1E293B;margin:40px 0 8px 70px">Market Cap Weight  ·  {freq_name} Rebalancing</h2>'
    div = generate_dynamic_benchmark_report(
        df_port,
        title=f"Market Cap Weight Portfolio  ·  {freq_name} Rebalancing",
        threshold=0.05,
    )
...
<head>
  <meta charset="utf-8">
  <title>Market Cap Weight Portfolio — All Frequencies</title>
</head>
