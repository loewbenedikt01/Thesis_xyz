"""
analyze_market_cap.py — Market Cap Portfolio Analysis
=========================================
...
for freq_name in FREQUENCIES:
    ...
    csv_path = DATA_DIR / f"portfolio_mktcap_{freq_name}.csv"
    ...
    section_title = (
        ...
        f'margin:40px 0 8px 70px">Market Cap  ·  {freq_name} Rebalancing</h2>'
    )
    div = generate_dynamic_benchmark_report(
        portfolio_df        = df_port,
        precomputed_results = results,
        title               = f"Market Cap Portfolio  ·  {freq_name} Rebalancing",
...
<head>
  <meta charset="utf-8">
  <title>Market Cap Portfolio — All Frequencies</title>
</head>
