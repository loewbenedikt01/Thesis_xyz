"""
analyze_equal_weight.py — Equal Weight Portfolio Analysis
==========================================================
...
for freq_name in FREQUENCIES:
    ...
    # Try v2 naming convention first, fall back to original
    csv_path = DATA_DIR / f"portfolio_ew_{freq_name}.csv"
    ...
    section_title = (
        ...
        f'margin:40px 0 8px 70px">Equal Weight  ·  {freq_name} Rebalancing</h2>'
    )
