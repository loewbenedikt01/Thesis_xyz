...
# ─────────────────────────────────────────────────────────────────────────────
MODEL_NAME  = "Markowitz Constrained"   # used in HTML titles
DATA_SUBDIR = "markowitz"   # subfolder under results/{data,metrics,plots}
...
for freq_name in FREQUENCIES:
    ...
    csv_path = DATA_DIR / f"portfolio_markowitz_{freq_name}.csv"
