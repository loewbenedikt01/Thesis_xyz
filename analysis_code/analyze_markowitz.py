...
output_dir_metrics = DATA_PATH / "results" / "metrics" / "markowitz"
output_dir_plots = DATA_PATH / "results" / "plots" / "markowitz"
output_dir_metrics.mkdir(parents=True, exist_ok=True)
output_dir_plots.mkdir(parents=True, exist_ok=True)
DATA_DIR = DATA_PATH / "results" / "data" / "markowitz"
...
<head>
  <meta charset="utf-8">
  <title>Markowitz Portfolio — All Frequencies</title>
</head>
