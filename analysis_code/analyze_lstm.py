"""
analyze_lstm.py — LSTM Portfolio Analysis
==========================================
...
# ─────────────────────────────────────────────────────────────────────────────
# LSTM-SPECIFIC: STATISTICS REPORT
# ─────────────────────────────────────────────────────────────────────────────
def generate_lstm_statistics_report(stats_df: pd.DataFrame, freq_name: str) -> str:
    """
    ...
    fig_ts.update_layout(
        title=dict(
            text=f"LSTM Prediction Quality Over Time  ·  {freq_name}",
...
for freq_name in FREQUENCIES:
    ...
    stats_div = generate_lstm_statistics_report(stats_df, freq_name)
